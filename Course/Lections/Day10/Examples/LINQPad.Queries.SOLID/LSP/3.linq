...
//посидев однажды в дебагере, поймет, что иногда (когда приходит DoubleList) 
...
//Нарушение контракта интерфейса IList привело к использованию оператора is (или as).
