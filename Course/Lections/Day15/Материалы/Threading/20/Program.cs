...
namespace _20
{
    ...
    class Program
    {
        ...
        {
            ActionQueue<string> action = new ActionQueue<string>(str => Console.WriteLine(str));
            action.EnqueueElement("one");
            action.EnqueueElement("two");
            action.EnqueueElement("three");
            action.Dispose();
            Console.ReadKey();
        }
    }
