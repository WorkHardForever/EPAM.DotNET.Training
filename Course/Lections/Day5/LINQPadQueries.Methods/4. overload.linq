...
public static void Main()
{
	...
	Add(new Object(), new Random(), ".NET Framework 4.0", 5);
...
#region
//нельзя перегрузить Add(int[] array) и Add(params int[] values)
...
#region
//нельзя будет вызвать метод Add без параметров
private static void Add(params Object[] objects)
{
