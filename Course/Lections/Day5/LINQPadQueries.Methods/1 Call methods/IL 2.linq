...
//IL_0002:  stloc.0     извлекает из стека верхнее значение и помещает его в локальную переменную i;Извлекает из стека значение и сохраняет его в локальной переменной с индексом index
...
//IL_0007:  dup         Копирует текущее верхнее значение в стеке вычислений и помещает копию в стек вычислений; дублирует верхний элемент в стеке и оставляет два одинаковых значения на вершине стека
//IL_0008:  ldc.i4.1    Помещает значение 1 в стек.
//IL_0009:  add         Складывает два числовых значения и возвращает новое числовое значение
