...
student.StudentName = "Updated Student 1"; 

StudentAddress sAddress = student.StudentAddress;

sAddress.Address1 = "Updated Address 1";
sAddress.Address2 = "Updated Address 2";
sAddress.City = "Updated City";
sAddress.State = "Updated State";
