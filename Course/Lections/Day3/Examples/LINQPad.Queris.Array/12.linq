...
Console.WriteLine(numbersSource.Equals(numbersClone));// вызывается экземплярный метод object-а
Console.WriteLine(Array.Equals(numbersSource,numbersClone));  //вызываются статические методы object-а
...
//https://habrahabr.ru/post/137680/
