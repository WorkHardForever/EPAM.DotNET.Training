...
class Point { public double x, y; public A a; }
class A { public int t; public A(int a) {t = a;}}
void Main()
{
	Point[] pointsSource = { new Point { x = 1, y = 1, a = new A(6)}, new Point { x = 2, y = 2, a = new A(7)} };
